...
basement["items"].append('Donald Trump')
...
attic["items"].append('Wedding Dress')
...
dumbwaiter["items"].append('Bucket')
...
secretRoom["items"].append('Hand Sanitizer')
